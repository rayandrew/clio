#ifndef __TRACE_UTILS_APP_STATS_CALCULATE_CALCULATE_RAW_TRACE_HPP__
#define __TRACE_UTILS_APP_STATS_CALCULATE_CALCULATE_RAW_TRACE_HPP__
...
class CalculateRawTraceApp : public App {
public:
    CalculateRawTraceApp();
    ~CalculateRawTraceApp();
