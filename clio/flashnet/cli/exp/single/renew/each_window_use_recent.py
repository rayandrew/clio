...
app = typer.Typer(
    name="Exp -- Single -- Renew Each Window -- Use Recent Model", help="Renew each window using the recent model", pretty_exceptions_enable=False
)


@app.callback()
def each_window_use_recent(
    data_dir: Annotated[
